import svgPaths from "./svg-5caq5t301y";
...
import imgEllipse55 from "./d2eae2aabaabbcc3fecfeffe6dde4884fea72eae.png";
import imgEllipse63 from "./7e090c8e1dee34283cd60ad6c8d5d3967a57e394.png";
import imgEllipse64 from "./17fe2917446856c8dbf7781b9a915060315522e8.png";
...
function IconBack() {
  return (
    <div className="absolute inset-[37.5%_88.27%_37.5%_7.47%]" data-name="Icon/Back">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon/Back">
          <path d={svgPaths.p1a166400} fill="var(--fill-0, #4F4F4F)" id="Vector" stroke="var(--stroke-0, #4F4F4F)" strokeWidth="0.5" />
        </g>
      </svg>
    </div>
  );
...
function Group3() {
  return (
    <div className="absolute contents inset-[15.63%_84.53%_15.63%_3.73%]">
      <div className="absolute bg-black inset-[15.63%_84.53%_15.63%_3.73%] opacity-0" />
      <IconBack />
    </div>
  );
}
...
function Header() {
  return (
    <div className="absolute h-[64px] left-0 top-[47px] w-[375px]" data-name="Header">
      ...
      <Group3 />
      <p className="[word-break:break-word] absolute font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold inset-[31.25%_36.53%_31.25%_36.27%] leading-[1.5] text-[#4f4f4f] text-[16px] text-center whitespace-nowrap">Leaderboard</p>
    </div>
  );
}
...
function Person() {
  return (
    <div className="col-1 content-stretch flex gap-[12px] items-center ml-[38px] mt-[8px] relative row-1 w-[165px]" data-name="Person">
      ...
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#4f4f4f] text-[14.4px] whitespace-nowrap">Marsha Fisher</p>
    </div>
  );
}
...
function Person1() {
  return (
    <div className="col-1 content-stretch flex gap-[12px] items-center ml-[38px] mt-[8px] relative row-1 w-[165px]" data-name="Person">
      ...
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#4f4f4f] text-[14.4px] whitespace-nowrap">Juanita Cormier</p>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      <div className="bg-[#c7f064] col-1 h-[48px] ml-0 mt-0 relative rounded-[12px] row-1 w-[343px]" />
...
function Person3() {
  return (
    <div className="col-1 content-stretch flex gap-[12px] items-center ml-[38px] mt-[8px] relative row-1 w-[165px]" data-name="Person">
      ...
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#4f4f4f] text-[14.4px] whitespace-nowrap">Tamara Schmidt</p>
    </div>
  );
}
...
function Person4() {
  return (
    <div className="col-1 content-stretch flex gap-[12px] items-center ml-[38px] mt-[8px] relative row-1 w-[165px]" data-name="Person">
      ...
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#4f4f4f] text-[14.4px] whitespace-nowrap">Ricardo Veum</p>
    </div>
  );
}
...
function Person5() {
  return (
    <div className="col-1 content-stretch flex gap-[12px] items-center ml-[38px] mt-[8px] relative row-1 w-[165px]" data-name="Person">
      ...
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#4f4f4f] text-[14.4px] whitespace-nowrap">Gary Sanford</p>
    </div>
  );
}
...
function Person6() {
  return (
    <div className="col-1 content-stretch flex gap-[12px] items-center ml-[38px] mt-[8px] relative row-1 w-[165px]" data-name="Person">
      ...
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#4f4f4f] text-[14.4px] whitespace-nowrap">Becky Bartell</p>
    </div>
  );
}
    ...
    <div className="-translate-x-1/2 absolute left-1/2 size-[28px] top-[94px]">
      <div className="absolute left-0 size-[28px] top-[4px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
          <circle cx="14" cy="14" fill="var(--fill-0, #C7F064)" id="Ellipse 78" r="14" />
        </svg>
      </div>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] left-[calc(50%+0.5px)] text-[16px] text-black text-center text-shadow-[0px_0px_13px_rgba(0,0,0,0.25)] top-[calc(50%-8px)] whitespace-nowrap">1</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="absolute left-[17px] size-[28px] top-[60px]">
      ...
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] left-1/2 text-[16px] text-black text-center text-shadow-[0px_0px_13px_rgba(0,0,0,0.25)] top-[calc(50%-9px)] whitespace-nowrap">2</p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="absolute left-[28px] size-[28px] top-[62px]">
      ...
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] left-1/2 text-[16px] text-black text-center text-shadow-[0px_0px_13px_rgba(0,0,0,0.25)] top-[calc(50%-8px)] whitespace-nowrap">3</p>
    </div>
  );
}
...
function IconMenuWorkout() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon/Menu/Workout">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_5_772)" id="Icon/Menu/Workout">
          <path d={svgPaths.p1dacd070} fill="var(--fill-0, #C7F064)" id="Vector" />
        </g>
        <defs>
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0">
      <IconMenuWorkout />
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[13px] text-black text-center whitespace-nowrap">43 pts</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[2px] items-center left-[calc(50%+0.5px)] top-[230px] w-[110px]">
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[14.4px] text-black text-center w-[110px]">Bryan Wolf</p>
      <Frame />
    </div>
  );
}

function IconMenuWorkout1() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon/Menu/Workout">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_5_772)" id="Icon/Menu/Workout">
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0">
      <IconMenuWorkout1 />
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[13px] text-black text-center whitespace-nowrap">40 pts</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[2px] items-center left-[calc(50%-108.5px)] top-[250px] w-[110px]">
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[14.4px] text-black text-center w-[109px]">Meghan Jes...</p>
      <Frame1 />
    </div>
  );
}

function IconMenuWorkout2() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon/Menu/Workout">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_5_772)" id="Icon/Menu/Workout">
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0">
      <IconMenuWorkout2 />
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[13px] text-black text-center whitespace-nowrap">38 pts</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] items-center left-[241px] top-[250px] w-[110px]">
      <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[14.4px] text-black text-center w-[94px]">Alex Turner</p>
      <Frame2 />
    </div>
  );
}
...
export default function Workout() {
  return (
    <div className="bg-white relative size-full" data-name="Workout">
      <StatusBarIPhone13Mini />
      <Header />
      <div className="absolute bg-[#f1f5e8] h-[494px] left-0 rounded-tl-[32px] rounded-tr-[32px] top-[318px] w-[375px]" />
      <AutoLayoutVertical />
      <Frame8 />
      <Frame6 />
      <Frame7 />
